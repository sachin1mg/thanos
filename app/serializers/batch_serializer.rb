class BatchSerializer < ApplicationSerializer
  attributes :id, :sku, :mrp, :manufacturing_date, :expiry_date, :code, :created_at, :updated_at
  ...
  def self.default_attributes
    [:id, :sku_id, :mrp, :manufacturing_date, :expiry_date, :code, :created_at, :updated_at]
  end
end
